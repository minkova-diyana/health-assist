...
function showMore(event){
    let parent = event.target.closest('.insurance-container');
    if (parent == null){
        parent = event.target.closest('.health-container')
    }
    const scrollContext = parent.querySelector('p')
    ...
    scrollContext.style.height = '300px';
    scrollContext.style.overflowY = 'scroll';
